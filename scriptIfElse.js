...
const wordList = [
    {
        word: "if",
        hint: "Statement to specify a block of C# code to be executed, if a condition is true."
    },
    
    {
        word: "else",
        hint: "Statement to specify a block of code to be executed, if the same condition is false."
    },
    
    {
        word: "else if",
        hint: "Statement to specify a new condition to test, if the first conditions is false."
    },
    ...
    {
        word: "less than",
        hint: "Operator that is used in this condition: a < b."
    },
    ...
    {
        word: "condition",
        hint: "Fill the syntax: if (condition) { // block of code}."
    },
];
